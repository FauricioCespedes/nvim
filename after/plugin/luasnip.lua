...
ls.cleanup()
for _, ft_path in ipairs(vim.api.nvim_get_runtime_file("lua/fauricio/snips/ft/*.lua", true)) do
...
vim.keymap.set("n", "<leader>rs", ":source ~/.config/nvim/after/plugin/luasnip.lua<CR>")
